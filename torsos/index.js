...
const male = {
  0: [
    { dlc: "mp_m_freemode_01", drawable: 0 },
    ...processNames(glob.sync("./male/0/*.png")),
  ],
  1: [
    { dlc: "mp_m_freemode_01", drawable: 1 },
    ...processNames(glob.sync("./male/1/*.png")),
  ],
  2: [
    { dlc: "mp_m_freemode_01", drawable: 2 },
    ...processNames(glob.sync("./male/2/*.png")),
  ],
  4: [
    { dlc: "mp_m_freemode_01", drawable: 4 },
    ...processNames(glob.sync("./male/4/*.png")),
  ],
  5: [
    { dlc: "mp_m_freemode_01", drawable: 5 },
    ...processNames(glob.sync("./male/5/*.png")),
  ],
  6: [
    { dlc: "mp_m_freemode_01", drawable: 6 },
    ...processNames(glob.sync("./male/6/*.png")),
  ],
  7: [{ dlc: "mp_m_freemode_01", drawable: 7 }],
  8: [
    { dlc: "mp_m_freemode_01", drawable: 8 },
    ...processNames(glob.sync("./male/8/*.png")),
  ],
  9: [{ dlc: "mp_m_freemode_01", drawable: 9 }],
  10: [{ dlc: "mp_m_freemode_01", drawable: 10 }],
  11: [
    { dlc: "mp_m_freemode_01", drawable: 11 },
    ...processNames(glob.sync("./male/11/*.png")),
  ],
  12: [
    { dlc: "mp_m_freemode_01", drawable: 12 },
    ...processNames(glob.sync("./male/12/*.png")),
  ],
  14: [
    { dlc: "mp_m_freemode_01", drawable: 14 },
    ...processNames(glob.sync("./male/14/*.png")),
  ],
  15: [
    { dlc: "mp_m_freemode_01", drawable: 15 },
...
const female = {
  0: [
    { dlc: "mp_f_freemode_01", drawable: 0 },
    ...processNames(glob.sync("./female/0/*.png")),
  ],
  1: [
    { dlc: "mp_f_freemode_01", drawable: 1 },
    ...processNames(glob.sync("./female/1/*.png")),
  ],
  2: [
    { dlc: "mp_f_freemode_01", drawable: 2 },
    ...processNames(glob.sync("./female/2/*.png")),
  ],
  3: [
    { dlc: "mp_f_freemode_01", drawable: 3 },
    ...processNames(glob.sync("./female/3/*.png")),
  ],
  4: [
    { dlc: "mp_f_freemode_01", drawable: 4 },
    ...processNames(glob.sync("./female/4/*.png")),
  ],
  5: [
    { dlc: "mp_f_freemode_01", drawable: 5 },
    ...processNames(glob.sync("./female/5/*.png")),
  ],
  6: [
    { dlc: "mp_f_freemode_01", drawable: 6 },
    ...processNames(glob.sync("./female/6/*.png")),
  ],
  7: [
    { dlc: "mp_f_freemode_01", drawable: 7 },
    ...processNames(glob.sync("./female/7/*.png")),
  ],
  8: [{ dlc: "mp_f_freemode_01", drawable: 8 }],
  9: [
    { dlc: "mp_f_freemode_01", drawable: 9 },
    ...processNames(glob.sync("./female/9/*.png")),
  ],
  10: [{ dlc: "mp_f_freemode_01", drawable: 10 }],
  11: [
    { dlc: "mp_f_freemode_01", drawable: 11 },
    ...processNames(glob.sync("./female/11/*.png")),
  ],
  12: [
    { dlc: "mp_f_freemode_01", drawable: 12 },
    ...processNames(glob.sync("./female/12/*.png")),
  ],
  13: [{ dlc: "mp_f_freemode_01", drawable: 13 }],
  14: [
    { dlc: "mp_f_freemode_01", drawable: 14 },
    ...processNames(glob.sync("./female/14/*.png")),
  ],
  15: [
    { dlc: "mp_f_freemode_01", drawable: 15 },
